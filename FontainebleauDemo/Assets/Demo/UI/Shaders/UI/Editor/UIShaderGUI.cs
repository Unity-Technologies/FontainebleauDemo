...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    public class UIShaderGUI : ShaderGUI
    {
        protected static class Styles
        {
            ...
            public static GUIContent uiTextureText = new GUIContent("UI Texture");
		...
		protected void SetupCommonOptionsKeywords(Material material)
		{
            ...
            material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.Transparent +1; // Hack to fix sorting
        ...
        MaterialProperty uiTexture = null;
        protected const string kUITexture = "_MainTex";
        ...
        {
            uiTexture = FindProperty(kUITexture, props);
        }

        protected void ShaderInputGUI()
        {
            m_MaterialEditor.TexturePropertySingleLine(Styles.uiTextureText, uiTexture);
        }
