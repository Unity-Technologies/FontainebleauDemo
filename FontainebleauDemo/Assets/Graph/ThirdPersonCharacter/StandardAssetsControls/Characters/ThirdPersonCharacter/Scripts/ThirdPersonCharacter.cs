	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		void ScaleCapsuleForCrouching(bool crouch)
		{
			...
			else
			{
				...
				if (Physics.SphereCast(crouchRay, m_Capsule.radius * k_Half, crouchRayLength, rayCastLayerMask, QueryTriggerInteraction.Ignore))
				{
					m_Crouching = true;
					return;
				}
		...
		void CheckGroundStatus()
		{
			...
			if (Physics.Raycast(transform.position + (Vector3.up * 0.1f), Vector3.down, out hitInfo, m_GroundCheckDistance, rayCastLayerMask, QueryTriggerInteraction.Ignore))
			{
